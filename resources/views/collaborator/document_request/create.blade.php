            ...
            <div class="shadow-lg flex-grow bg-white p-10 ml-[40px] mt-[50px] overflow-y-auto">
                <form method="post" action="{{ route('document-request.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="flex whitespace-nowrap flex-col md:flex-row justify-between items-center mb-5">
                        <x-title class="md:mr-4">{{ __('REQUEST A DOCUMENT') }}</x-title>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-12">
                        <div class="relative z-0 w-full mb-6 group">
                            <label for="type"
                                class="block  text-sm font-medium text-gray-700 dark:text-gray-400">{{ __('TYPE') }}</label>
                            <select name="type"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                required>
                                <option value="payroll statement">
                                    Payroll statement
                                </option>
                            ...
                            <div class="relative w-full my-10 group">
                                ...
                                <textarea name="description" rows="5" placeholder="Write description here..."
                        ...
                        <div class="max-w-xl flex flex-col">
                            ...
                            <label
                                ...
                                <input id="file_upload" type="file" name="attached_files[]" class="hidden" multiple>
                            </label>
